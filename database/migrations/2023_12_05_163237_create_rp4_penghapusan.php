...
return new class extends Migration
{
    ...
    {
        Schema::create('rp4_penghapusan', function (Blueprint $table) {
            $table->id();
            ...
            $table->float('rp4_luas_tanah_atau_bangunan')->nullable();
            $table->bigInteger('rp4_jumlah_barang')->nullable();
            $table->float('rp4_nilai_perolehan')->nullable();
            $table->text('rp4_alasan_rencana_penghapusan')->nullable();
    ...
    {
        Schema::dropIfExists('rp4_penghapusan');
    }
};
