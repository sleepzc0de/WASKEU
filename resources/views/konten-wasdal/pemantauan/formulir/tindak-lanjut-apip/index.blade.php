...
$(function () {
    ...
    if (dt_basic_table.length) {
        dt_basic = dt_basic_table.DataTable({
            ...
            serverSide: true,
            ajax: "{{ route('form-tindak-lanjut-apip.index') }}",
            autoWidth: true,
            scrollY: 200,
            scrollX: true,
            columns: [
                ...
                { data: "nama_barang", name: "nama_barang" },
                 { data: "nup", name: "nup" },
                  ...
                  { data: "ket_hasil_temuan_apip", name: "ket_hasil_temuan_apip" },
                  { data: "tindak_lanjut_apip", name: "tindak_lanjut_apip" },
                  { data: "ket_tinjut_apip", name: "ket_tinjut_apip" },
        ...
        $("div.head-label").html(
            '<h5 class="card-title mb-0">Penggunaan - Tindak Lanjut BMN Temuan APIP</h5>'
...
@if (count($data) <= 0)
<div class="py-2">
    <a href="{{ route('form-tindak-lanjut-apip.create') }}" class="btn btn-label-primary btn-fab demo">
