...
@section('content')
    <div class="col-xxl">
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form action="{{ route('form-penggunaan-sementara.store') }}" method="post" enctype="multipart/form-data"
                    autocomplete="off">
                    @csrf
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <select data-allow-clear="true" name="dok_rp4" class="select2 form-select form-select-lg"
                                ...
                                @foreach ($dok_rp4 as $item)
                                    <option value="{{ $item->dok_rp4 }}">{{ $loop->iteration . ' - ' . $item->ur_dok_rp4 }}
                                    </option>
                                @endforeach
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <select data-allow-clear="true" name="status_persetujuan"
                                class="select2 form-select form-select-lg" id="status_persetujuan"
                                aria-label="Status Persetujuan">
                                <option selected disabled>Pilih Status Persetujuan</option>
                                @foreach ($status_persetujuan as $item)
                                    <option value="{{ $item->status_persetujuan }}">
                                        {{ $loop->iteration . ' - ' . $item->ur_status_persetujuan }}</option>
                                @endforeach
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <select data-allow-clear="true" name="bentuk_persetujuan"
                                class="select2 form-select form-select-lg" id="bentuk_persetujuan"
                                aria-label="Bentuk Persetujuan">
                                <option selected disabled>Pilih Bentuk Persetujuan</option>
                                @foreach ($bentuk_persetujuan as $item)
                                    <option value="{{ $item->bentuk_persetujuan }}">
                                        {{ $loop->iteration . ' - ' . $item->ur_bentuk_persetujuan }}</option>
                                @endforeach
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <select data-allow-clear="true" name="status_pelaksanaan"
                                class="select2 form-select form-select-lg" id="status_pelaksanaan"
                                aria-label="Status Pelaksanaan">
                                <option selected disabled>Pilih Status Pelaksanaan</option>
                                @foreach ($status_pelaksanaan as $item)
                                    <option value="{{ $item->status_pelaksanaan }}">
                                        {{ $loop->iteration . ' - ' . $item->ur_status_pelaksanaan }}</option>
                                @endforeach
