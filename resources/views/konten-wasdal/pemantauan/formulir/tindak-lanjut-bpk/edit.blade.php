...
@section('content')
    <div class="col-xxl">
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form action="{{ route('form-tindak-lanjut-bpk.update',$data->id) }}" method="post" enctype="multipart/form-data"
                    autocomplete="off">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            ...
                            {{ old('ket_hasil_temuan_bpk') ?? $data->ket_hasil_temuan_bpk }}
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            ...
                            {{ old('ket_tinjut_bpk') ?? $data->ket_tinjut_bpk }}
