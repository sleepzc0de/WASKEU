                    ...
                    <div id="form-credit-card" class="row">
                        <div class="col-12 col-md-12 col-xl-12">
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <select data-allow-clear="true" id="jenis_barang" value="{{ old('jenis_barang') }}"
                                        ...
                                        <option value="{{ $item->kd_jns_bmn }}" {{ old('siman')==$item->kd_jns_bmn ?
                                            'selected' :
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <select data-allow-clear="true" id="nup_barang" value="{{ old('nup') }}" name="nup"
                                        class="select2 form-select form-select-lg" @error('nup') is-invalid @enderror
                                        required>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <select name="status_psp" class="form-select" id="status_psp"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input name="no_psp" type="text" class="form-control" id="no_psp"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input name="tgl_psp" id="tgl_psp" class="form-control" type="date"
                                        id="html5-date-input" />
                                </div>
                            </div>
                            <div class="row mb-3">
