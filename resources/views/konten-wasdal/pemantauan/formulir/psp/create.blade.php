        ...
        <div class="card-body">
            <form action="{{route('form-psp.store')}}" method="post" enctype="multipart/form-data" autocomplete="off">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <select data-allow-clear="true" name="status_psp" class="select2 form-select form-select-lg"
                            id="status_psp" aria-label="Status PSP">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                         <input name="nomor_psp" type="text"
                            class="form-control" id="nomor_psp" placeholder="Nomor PSP" />
                    </div>
                </div>
                <div class="row mb-3">
                    <label class="col-sm-2 col-form-label" for="tanggal_psp">Tanggal PSP</label>
                    <div class="col-sm-10">
                        <input name="tanggal_psp"
                            id="tanggal_psp" class="form-control" type="date" id="html5-date-input" />
                    </div>
                </div>
                <div class="row mb-3">
