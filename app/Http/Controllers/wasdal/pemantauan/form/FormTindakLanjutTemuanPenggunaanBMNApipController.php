...
class FormTindakLanjutTemuanPenggunaanBMNApipController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        if ($KPB) {
            ...
            if (request()->ajax()) {
                ...
                return datatables()->of($query)
                    ->addColumn('opsi', function ($query) {
                        ...
                        $edit = route('form-tindak-lanjut-apip.edit', $query->id);
                        $hapus = route('form-tindak-lanjut-apip.destroy', $query->id);
                        return '
            ...
            if (request()->ajax()) {
                ...
                return datatables()->of($query)
                    ->addColumn('opsi', function ($query) {
                        // $preview = route('form-tindak-lanjut-apip.show', $query->id);
                        $edit = route('form-tindak-lanjut-apip.edit', $query->id);
                        $hapus = route('form-tindak-lanjut-apip.destroy', $query->id);
                        return '
                        <div style="display: flex; justify-content: space-between;">
        ...
        return view('konten-wasdal.pemantauan.formulir.tindak-lanjut-apip.index', compact('data'));
    }
    ...
    public function create()
    {
        ...
        // $tindak_lanjut_apip = ref_status_persetujuan::all();
        ...
        return view('konten-wasdal.pemantauan.formulir.tindak-lanjut-apip.create', compact(['data', 'refKodeBarang','refJenisBarang','refTindakLanjut']));
    ...
    public function store(Request $request)
    {
        try {
            ...
            $status_sesuai_Form7 = ($request->tindak_lanjut_apip != 'BELUM_TL') ? 'SESUAI' : 'TIDAK SESUAI';
            ...
            $user =  PenggunaanModel::create([
                ...
                'ket_hasil_temuan_apip' => $request->ket_hasil_temuan_apip,
                'tindak_lanjut_apip' => $request->tindak_lanjut_apip,
                'ket_tinjut_apip' => $request->ket_tinjut_apip,
                'status_sesuai_Form7' => $status_sesuai_Form7,
                'isCompletedForm7' => true,
        ]);

            return redirect()->route('form-tindak-lanjut-apip.index')->with('success', "Data berhasil ditambah!");
        } catch (Exception $e) {
            return redirect()->route('form-tindak-lanjut-apip.index')->with(['failed' => 'Data gagal ditambah! error :' . $e->getMessage()]);
        }
    }
    /**
    ...
    public function edit(string $id)
    {
        ...
        return view('konten-wasdal.pemantauan.formulir.tindak-lanjut-apip.edit', compact(['data', 'refKodeBarang','refJenisBarang','refTindakLanjut']));
    }
    ...
    public function update(Request $request, string $id)
    {
        try {
            ...
            return redirect()->route('form-tindak-lanjut-apip.index')->with('success', "Data berhasil diupdate!");
        } catch (Exception $e) {
            return redirect()->route('form-tindak-lanjut-apip.index')->with(['failed' => 'Data gagal diupdate! error :' . $e->getMessage()]);
        }
    }
