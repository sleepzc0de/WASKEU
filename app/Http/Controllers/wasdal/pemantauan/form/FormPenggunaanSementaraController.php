...
class FormPenggunaanSementaraController extends Controller
{
    ...
    public function index()
    {
        ...
        if ($KPB) {
            ...
            // dd($dataToInsert);
            $query = PenggunaanModel::where('kode_satker', Auth::user()->satker)->where('bentuk_rp4_penggunaan', 'LIKE','%sementara%')->where('isRP4Penggunaan',true)->where('role', 'KPB')->select('*');
            // dd($query);
            ...
            $data = PenggunaanModel::where('kode_satker', Auth::user()->satker)->where('bentuk_rp4_penggunaan', 'LIKE','%sementara%')->where('isRP4Penggunaan',true)->where('role', 'KPB')->get();
            // dd($data);
        } elseif ($KANWIL) {
            ...
            $data = PenggunaanModel::whereRaw('LEFT(kode_anak_satker,9) = ?', [Auth::user()->satker])->where('bentuk_rp4_penggunaan', 'LIKE','%sementara%')->where('isRP4Penggunaan',true)->where('role', 'PPB-W')->get();
        } elseif ($ES1) {
            ...
            $data = PenggunaanModel::whereRaw('LEFT(kode_anak_satker,5) = ?', [Auth::user()->satker])->where('bentuk_rp4_penggunaan', 'LIKE','%sementara%')->where('isRP4Penggunaan',true)->where('role', 'PPB-E1')->get();
        } elseif ($PENGGUNA) {
            ...
            $data = PenggunaanModel::whereRaw('LEFT(kode_anak_satker,3) = ?', [Auth::user()->satker])->where('bentuk_rp4_penggunaan', 'LIKE','%sementara%')->where('isRP4Penggunaan',true)->where('role', 'PB')->get();
        } elseif ($PENGELOLA) {
            ...
            $data = PenggunaanModel::whereRaw('LEFT(kode_anak_satker,3) = ?', [Auth::user()->satker])->where('bentuk_rp4_penggunaan', 'LIKE','%sementara%')->where('isRP4Penggunaan',true)->where('role', 'PENGELOLA')->get();
        } elseif ($AUDITOR) {
            ...
            $data = PenggunaanModel::whereRaw('LEFT(kode_anak_satker,3) = ?', [Auth::user()->satker])->where('bentuk_rp4_penggunaan', 'LIKE','%sementara%')->where('isRP4Penggunaan',true)->where('role', 'AUDITOR')->get();
        }
    ...
    public function create()
    {
        ...
        return view('konten-wasdal.pemantauan.formulir.penggunaan-sementara.create', compact(['data', 'dok_rp4','status_persetujuan','bentuk_persetujuan','status_pelaksanaan','refKodeBarang','refJenisBarang']));
    ...
    public function store(Request $request)
    {
        try {
            ...
            $user =  PenggunaanModel::create([
                ...
                'bentuk_rp4_penggunaan' => 'Penggunaan sementara BMN',
            ...
            return redirect()->route('form-penggunaan-sementara.index')->with('success', "Data berhasil ditambah!");
        } catch (Exception $e) {
            return redirect()->route('form-penggunaan-sementara.index')->with(['failed' => 'Data gagal ditambah! error :' . $e->getMessage()]);
        }
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('konten-wasdal.pemantauan.formulir.penggunaan-sementara.edit', compact(['data', 'dok_rp4','status_persetujuan','bentuk_persetujuan','status_pelaksanaan','refKodeBarang']));
    }
